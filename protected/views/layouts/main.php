	...
	<div class="container" id="page">
		...
		<?php $this->widget('application.extensions.mbmenu.MbMenu',array(
			'items'=>array(
				...
				array('label'=>'Profile', 'url'=>Yii::app ()->getModule ( 'user' )->profileUrl, 'visible'=>!Yii::app()->user->isGuest,'items'=>array(
					array('label'=>'Edit Profile', 'url'=>Yii::app ()->getModule ( 'user' )->editProfileUrl),
					array('label'=>'Change Password', 'url'=>Yii::app ()->getModule ( 'user' )->changePasswordUrl))),
